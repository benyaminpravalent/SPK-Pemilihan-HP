...
<body>
    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container">
			<div class="section no-pad-bot">
				<div class="container">
					<h1 class="header jarak center white-text" style="font-size: 40px">SISTEM PENDUKUNG KEPUTUSAN MENGGUNAKAN METODE SAW DAN METODE TOPSIS</h1>
			...
			<div class="parallax"><img src="assets/image/purple.jpg" alt="Laptop"></div>
		</div>
		<!-- Jumbotron End -->
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode SAW dan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Decision Support System Prodi Ilmu Komputer Universitas Sumatera Utara. </p>
						</div>
			    	<div class="col s6">
			    		<center><h5 class="header" style="margin-left: 0px; margin-bottom: 0px; margin-top: 25px; color: #635c73">INFO METODE</h5></center><br>
							<p style="text-align: justify; padding-left: 16px;">Metode yang digunakan adalah metode SAW dan metode TOPSIS. Metode Simple Additive Weighting (SAW) sering juga dikenal dengan istilah metode penjumlahan terbobot. Konsep dasar metode SAW adalah mencari penjumlahan terbobot dari rating kinerja pada setiap alternatif pada semua atribut. Metode TOPSIS adalah salah satu metode penyelesaian pada sistem pendukung keputusan. Metode ini mengevaluasi beberapa alternatif terhadap sekumpulan atribuat atau kriteria, dimana setiap atribut saling tidak bergantung satu dengan yang lainnya.
							</p>
							</div>
		    	</div>
	    	</div>
    ...
    <div class="modal-content">
      <h4>Tentang</h4>
      <p>Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode SAW dan metode TOPSIS yang dibangun menggunakan bahasa PHP.
				Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Decision Support System Prodi Ilmu Komputer Universitas Sumatera Utara. <br>
				<br>
				1. Istikanah Wulandari - 181401004<br>
				2. Benyamin Pravalent Siregar - 181401109 <a href="https://github.com/benyaminpravalent"> (GitHub)</a><br>
				3. Ahmad Fadhil - 181401019<br>
			</p>
    </div>
